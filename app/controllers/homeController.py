...
from app.config.settings import  init_app, Resource
from app.services.maillingService import MaillingService
...
class HomeController(Resource):
    ...
    def main_page():
        maillingService = MaillingService().send("test python", ["sdanicktakam@yahoo.fr"], "I am a simple python test")
